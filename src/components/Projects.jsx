...
const projects = [
  {
    title: 'Runity App',
    desc: 'App móvil de seguimiento de actividad física (calorías, pasos, distancia y duración) con arquitectura desacoplada.',
    tags: ['React', 'FastAPI', 'PostgreSQL', 'Docker'],
    learning: 'Arquitectura desacoplada y API REST.',
    img: 'https://opengraph.githubassets.com/1/DIEGUSPLAY12/Runity-App',
    href: 'https://github.com/DIEGUSPLAY12/Runity-App',
    glow: 'group-hover:shadow-glow',
  },
  {
    title: 'AporTamos',
    desc: 'Plataforma para organizar, asignar y hacer seguimiento de las tareas domésticas en la convivencia.',
    tags: ['React', 'FastAPI', 'PostgreSQL', 'Docker'],
    learning: 'Gestión de tareas y lógica de backend.',
    img: 'https://opengraph.githubassets.com/1/DIEGUSPLAY12/AporTamos',
    href: 'https://github.com/DIEGUSPLAY12/AporTamos',
    glow: 'group-hover:shadow-[0_0_32px_rgba(139,92,246,0.3)]',
  },
  {
    title: 'PerfecT-Shirt',
    desc: 'E-commerce de camisetas de fútbol con catálogo, gestión de usuarios y carrito de compra.',
    tags: ['Laravel', 'MySQL', 'JavaScript', 'Docker'],
    learning: 'Lógica de negocio y bases de datos.',
    img: 'https://opengraph.githubassets.com/1/DIEGUSPLAY12/PerfecT-Shirt',
    href: 'https://github.com/DIEGUSPLAY12/PerfecT-Shirt',
