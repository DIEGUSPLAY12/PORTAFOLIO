  ...
  return (
    ...
    >
      <div className="mx-4 mt-4">
        <nav className="glass-strong rounded-2xl px-5 py-3 flex items-center justify-between max-w-6xl mx-auto">
          <motion.a
            href="#inicio"
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <ul className="glass-strong rounded-2xl p-2 flex flex-col gap-1">
              {links.map(({ href, label }) => (
                <li key={href}>
                  <a
                    href={href}
